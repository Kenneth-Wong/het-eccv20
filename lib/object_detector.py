...
class Result(object):
    ...
    def __init__(self, od_obj_dists=None, rm_obj_dists=None,
                 ...
                 rpn_scores=None, rpn_box_deltas=None, rel_labels=None, rels_to_gt=None,
                 im_inds=None, fmap=None, rel_dists=None, rel_inds=None, rel_rep=None,
                 rel_anchor_scores = None,
                 rel_proposal_inds=None, rel_proposal_scores=None, rel_proposal_labels=None,
                 rel_rank_scores=None, rel_rank_dists=None, att_values=None,
                 keylabel_byfgbg=None, keylabel_bykeyrel=None, prod_rep=None):
...
class ObjectDetector(nn.Module):
    ...
    def gt_boxes(self, fmap, im_sizes, image_offset, gt_boxes=None, gt_classes=None, gt_rels=None,
        ...
        if gt_rels is not None and self.training:
            rois, labels, rel_labels, rels_to_gt = proposal_assignments_gtbox(
        ...
        return rois, labels, None, None, None, rel_labels, rels_to_gt
    ...
    def forward(self, x, im_sizes, image_offset,
                ...
                sal_maps=None, return_fmap=False):
        """
        ...
        # Get boxes from RPN
        rois, obj_labels, bbox_targets, rpn_scores, rpn_box_deltas, rel_labels, rels_to_gt = \
    ...
    def __getitem__(self, batch):
        ...
        outputs = nn.parallel.parallel_apply(replicas, [batch[i][:9] for i in range(self.num_gpus)])
